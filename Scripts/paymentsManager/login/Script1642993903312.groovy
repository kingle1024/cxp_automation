...
WebUI.openBrowser(GlobalVariable.PAYMENT_MANAGER)
WebUI.verifyElementPresent(CustomKeywords.'common.dy.getMyTestObject'('//*[@src="//auth.dev.tosspayments.bz"]'), 5, FailureHandling.STOP_ON_FAILURE)
WebUI.switchToFrame(CustomKeywords.'common.dy.getMyTestObject'('//*[@src="//auth.dev.tosspayments.bz"]'), 5, FailureHandling.STOP_ON_FAILURE)
